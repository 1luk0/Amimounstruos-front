...
public class HistoriaAgua6Activity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_historia_agua6);
      ...
      botonContinue.setOnClickListener(v -> {
        Intent intent = new Intent(HistoriaAgua6Activity.this, HistoriaAgua7Activity.class);
        startActivity(intent);
      });

      botonNiveles.setOnClickListener(v -> {
        Intent intent = new Intent(HistoriaAgua6Activity.this, NivelesmaActivity.class);
        startActivity(intent);
      });
    }
}
