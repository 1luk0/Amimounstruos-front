...
public class CorrectoAnimalesActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_correcto_animales);
      ...
      botonContinue.setOnClickListener(v -> {
        Intent intent = new Intent(CorrectoAnimalesActivity.this, PreguntaPersonasActivity.class);
        startActivity(intent);
      });

      botonNiveles.setOnClickListener(v -> {
        Intent intent = new Intent(CorrectoAnimalesActivity.this, NivelesmaActivity.class);
        startActivity(intent);
      });
    }
}
